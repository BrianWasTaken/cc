...
import type { CreateFunctionType } from "types/utility";
...
export abstract class Builder {
  ...
  public static build<T>(
    instance: T,
    builder: Builder.Callback<T, Promise<T>>,
  ): Promise<T>;
  public static build<T>(
    instance: T,
    builder: Builder.Callback<T, Promise<T>>,
   ...
   */
  public static flat<T, A extends Arr = []>(
    ctor: Ctor<A, T>,
    args: A,
    ...builders: RestOrArray<T> | RestOrArray<Builder.Callback<T>>
  ) {
    return builders.flatMap((builder) => {
      const build = (builder: T | Builder.Callback<T>) =>
        isFunction(builder)
          ? Builder.build(new ctor(...args), builder)
          : builder;
...
export class ComponentRowBuilder<
  T extends ComponentRowBuilder.ComponentTypes,
> extends Mixin(Builder, ActionRowBuilder) {
  public declare components: ComponentRowBuilder.ComponentMappings[T][];
  ...
  public override addComponents(
    ...components: RestOrArray<
      Builder.Callback<ComponentRowBuilder.ComponentMappings[T]>
    >
  ): this;
  public override addComponents(
    ...components: RestOrArray<ComponentRowBuilder.ComponentMappings[T]>
  ): this;
  public override addComponents(
    ...components:
      | RestOrArray<ComponentRowBuilder.ComponentMappings[T]>
      | RestOrArray<Builder.Callback<ComponentRowBuilder.ComponentMappings[T]>>
  ): this {
    return super.addComponents(
      Builder.flat(
        this.Constructor as unknown as Ctor<
          [],
          ComponentRowBuilder.ComponentMappings[T]
        >,
        [],
        ...components,
      ),
 ...
 */
export class StringSelectMenuComponentBuilder extends Mixin(
  Builder,
  StringSelectMenuBuilder,
) {
  public override addOptions(
    ...options: RestOrArray<Builder.Callback<StringSelectMenuOptionBuilder>>
  ): this;
  public override addOptions(
    ...options: RestOrArray<StringSelectMenuOptionBuilder>
  ): this;
  public override addOptions(
    ...options:
      | RestOrArray<StringSelectMenuOptionBuilder>
      | RestOrArray<Builder.Callback<StringSelectMenuOptionBuilder>>
  ): this {
    return super.addOptions(
      Builder.flat(StringSelectMenuOptionBuilder, [], ...options),
    );
  }
}
 ...
 */
export class MessageAttachmentBuilder extends Mixin(
  Builder,
  AttachmentBuilder,
) {}
  ...
  implements Omit<BaseMessageOptions, "content">
{
  ...
  public components: BaseMessageOptions["components"] &
    ComponentRowBuilder<TComponents>[] = [];
  ...
  public addComponentRow(
    ...
    void container.utilities["array"].insertElement(
      (this.components ??= []),
  ...
  public removeComponentRow(rowIndex: number) {
    void container.utilities["array"].extractElement(
      (this.components ??= []),
  ...
  public addEmbed(embedCb: Builder.Callback<MessageEmbedBuilder>) {
    void container.utilities["array"].insertElement(
      (this.embeds ??= []),
      Builder.build(new MessageEmbedBuilder(), embedCb),
    );
  ...
  public addFile(fileCb: Builder.Callback<MessageAttachmentBuilder>) {
    void container.utilities["array"].insertElement(
      (this.files ??= []),
      Builder.build(new MessageAttachmentBuilder(), fileCb),
    );
  ...
  implements MessageCreateOptions
{
  ...
  public setFlags(
    flags: Exclude<MessageCreateOptions["flags"], undefined> | null,
  ) {
    if (isNullish(flags)) {
      delete this.flags;
    } else {
...
export class EditMessageBuilder<
    TComponents extends
      ComponentRowBuilder.ComponentTypes = ComponentRowBuilder.ComponentTypes,
  >
  extends BaseMessageBuilder<TComponents>
  implements MessageEditOptions
{
  ...
  public setFlags(
    flags: Exclude<MessageEditOptions["flags"], undefined> | null,
  ) {
    if (isNullish(flags)) {
      delete this.flags;
    } else {
...
> extends BaseMessageBuilder<TComponents> {
  ...
  public setFlags(
    flags: Exclude<BitFieldResolvable<Flags, number>, undefined> | null,
  ) {
    if (isNullish(flags)) {
      delete this.flags;
    } else {
...
export class InteractionMessageBuilder<
    TComponents extends
      ComponentRowBuilder.ComponentTypes = ComponentRowBuilder.ComponentTypes,
  >
  extends BaseInteractionMessageBuilder<
    TComponents,
  ...
  implements InteractionReplyOptions, InteractionEditReplyOptions
{
  ...
  public fetchReply?: InteractionReplyOptions["fetchReply"];
...
export class UpdateInteractionMessageBuilder<
    TComponents extends
      ComponentRowBuilder.ComponentTypes = ComponentRowBuilder.ComponentTypes,
  >
